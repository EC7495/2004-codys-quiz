...
describe('FavoriteFoods', () => {
  describe('should render out a list of food props it receives', () => {
    ...
    it('renders each <li> with the name of each food', () => {
      ...
      expect(FavoriteFoodsWrapper.contains(<li>Peanut Butter</li>)).to.be.equal(
        true
      );
      expect(FavoriteFoodsWrapper.contains(<li>Pancakes</li>)).to.be.equal(
        true
      );
    });
    ...
    it('changes if a different set of food is sent down as props', () => {
      ...
      expect(FavoriteFoodsWrapper.contains(<li>Pita bread</li>)).to.be.equal(
        true
      );
      expect(FavoriteFoodsWrapper.contains(<li>Pudding</li>)).to.be.equal(true);
      expect(FavoriteFoodsWrapper.contains(<li>Porkchops</li>)).to.be.equal(
        true
      );
